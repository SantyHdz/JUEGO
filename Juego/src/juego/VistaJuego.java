...
public class VistaJuego {
    ...
    public void iniciarJuego() {
        ...
        while (continuarJugando) {
            ...
            String nombreJugador = JOptionPane.showInputDialog(null, "Introduce tu nombre:"); // Pide el nombre del jugador al inicio del juego
            ...
            while (intentos < 12 && !juegoGanado) {
                ...
                if (resultado[0] == 4) {
                    ...
                    JOptionPane.showMessageDialog(null, "Has agotado todos los intentos. El código era secreto.");
                }
            }
